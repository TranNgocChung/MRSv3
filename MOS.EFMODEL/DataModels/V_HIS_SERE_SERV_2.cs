...
namespace MOS.EFMODEL.DataModels
{
    ...
    public partial class V_HIS_SERE_SERV_2
    {
        ...
        public string MEDICINE_BID_NUMBER { get; set; }
        public string MEDICINE_BID_YEAR { get; set; }
        public string ACTIVE_INGR_BHYT_CODE { get; set; }
        public string ACTIVE_INGR_BHYT_NAME { get; set; }
        public string MEDICINE_BID_EXTRA_CODE { get; set; }
        public string CONCENTRA { get; set; }
        public Nullable<long> MEDICINE_USE_FORM_ID { get; set; }
        public Nullable<long> MEDICINE_LINE_ID { get; set; }
        public Nullable<short> MEDICINE_IS_ANAESTHESIA { get; set; }
        ...
        public string MATERIAL_BID_NUMBER { get; set; }
        public string MATERIAL_BID_YEAR { get; set; }
        public string MATERIAL_BID_EXTRA_CODE { get; set; }
        ...
        public string OLD_HST_BHYT_CODE { get; set; }
        public Nullable<long> HST_BHYT_CODE_IN_TIME { get; set; }
        public string MATERIAL_SERIAL_NUMBER { get; set; }
