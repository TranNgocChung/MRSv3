...
namespace MOS.EFMODEL.DataModels
{
    ...
    public partial class V_HIS_TREATMENT_FEE
    {
        ...
        public Nullable<decimal> TOTAL_OTHER_COPAID_PRICE { get; set; }
        public Nullable<decimal> TOTAL_PATIENT_PRICE { get; set; }
        public Nullable<decimal> TOTAL_DISCOUNT { get; set; }
        public Nullable<decimal> TOTAL_PRICE_EXPEND { get; set; }
        public Nullable<decimal> COUNT_HEIN_APPROVAL { get; set; }
        public Nullable<decimal> TOTAL_DEBT_AMOUNT { get; set; }
        public Nullable<decimal> TOTAL_PATIENT_PRICE_BHYT { get; set; }
        public Nullable<decimal> TOTAL_OTHER_SOURCE_PRICE { get; set; }
        public Nullable<decimal> LAST_DEPOSIT_TIME { get; set; }
        public Nullable<decimal> TOTAL_SERVICE_DEPOSIT_AMOUNT { get; set; }
        ...
        public Nullable<short> DIS_DEPOSIT_OPTION_REQUEST { get; set; }
        public Nullable<decimal> LOCKING_AMOUNT { get; set; }
    }
}
