...
namespace MOS.EFMODEL.DataModels
{
    ...
    public partial class HIS_SERVICE_REQ
    {
        public HIS_SERVICE_REQ()
        {
            ...
            this.HIS_DRUG_INTERVENTION = new HashSet<HIS_DRUG_INTERVENTION>();
            this.HIS_EXAM_SERE_DIRE = new HashSet<HIS_EXAM_SERE_DIRE>();
            this.HIS_EXP_MEST = new HashSet<HIS_EXP_MEST>();
            this.HIS_EXP_MEST1 = new HashSet<HIS_EXP_MEST>();
            this.HIS_KSK_DRIVER = new HashSet<HIS_KSK_DRIVER>();
            this.HIS_KSK_DRIVER_CAR = new HashSet<HIS_KSK_DRIVER_CAR>();
            this.HIS_KSK_GENERAL = new HashSet<HIS_KSK_GENERAL>();
            this.HIS_KSK_OCCUPATIONAL = new HashSet<HIS_KSK_OCCUPATIONAL>();
            this.HIS_KSK_OTHER = new HashSet<HIS_KSK_OTHER>();
            this.HIS_KSK_OVER_EIGHTEEN = new HashSet<HIS_KSK_OVER_EIGHTEEN>();
            this.HIS_KSK_PERIOD_DRIVER = new HashSet<HIS_KSK_PERIOD_DRIVER>();
            this.HIS_KSK_UNDER_EIGHTEEN = new HashSet<HIS_KSK_UNDER_EIGHTEEN>();
            ...
            this.HIS_SERVICE_REQ11 = new HashSet<HIS_SERVICE_REQ>();
        ...
        public Nullable<long> CARER_CARD_BORROW_ID { get; set; }
        public Nullable<short> IS_FOR_AUTO_CREATE_RATION { get; set; }
        public Nullable<long> USED_FOR_TRACKING_ID { get; set; }
        ...
        public Nullable<long> RECEIVE_SAMPLE_TIME { get; set; }
        public Nullable<long> APPOINTMENT_EXAM_ROOM_ID { get; set; }
        public Nullable<long> APPOINTMENT_EXAM_SERVICE_ID { get; set; }
        public Nullable<long> TRANS_REQ_ID { get; set; }
        public Nullable<short> IS_TEMPORARY_PRES { get; set; }
        public Nullable<long> ATTACHED_ID { get; set; }
        public Nullable<short> ALLOW_SEND_PACS { get; set; }
        public string MACHINE_NAMES { get; set; }
        public Nullable<long> RATION_SCHEDULE_ID { get; set; }
        public string PART_EXAM_EYE_TENSION { get; set; }
        public Nullable<short> PART_EXAM_EYE_ST_PLUS { get; set; }
        public Nullable<short> PART_EXAM_EYE_ST_MINUS { get; set; }
        public string PART_EXAM_EYE_COUNT_FINGER { get; set; }
        public string PART_EYE_GLASS_OLD_SPH_LEFT { get; set; }
        public string PART_EYE_GLASS_OLD_SPH_RIGHT { get; set; }
        public string PART_EYE_GLASS_OLD_CYL_LEFT { get; set; }
        public string PART_EYE_GLASS_OLD_CYL_RIGHT { get; set; }
        public string PART_EYE_GLASS_OLD_AXE_LEFT { get; set; }
        public string PART_EYE_GLASS_OLD_AXE_RIGHT { get; set; }
        public string PART_EYESIGHT_GLASS_OLD_LEFT { get; set; }
        public string PART_EYESIGHT_GLASS_OLD_RIGHT { get; set; }
        public string PART_EYE_GLASS_OLD_ADD_LEFT { get; set; }
        public string PART_EYE_GLASS_OLD_ADD_RIGHT { get; set; }
        public string PART_EYE_GLASS_SPH_LEFT { get; set; }
        public string PART_EYE_GLASS_SPH_RIGHT { get; set; }
        public string PART_EYE_GLASS_CYL_LEFT { get; set; }
        public string PART_EYE_GLASS_CYL_RIGHT { get; set; }
        public string PART_EYE_GLASS_AXE_LEFT { get; set; }
        public string PART_EYE_GLASS_AXE_RIGHT { get; set; }
        public string PART_EYE_GLASS_ADD_LEFT { get; set; }
        public string PART_EYE_GLASS_ADD_RIGHT { get; set; }
        public string PART_EYE_GLASS_OLD_KCDT_LEFT { get; set; }
        public string PART_EYE_GLASS_OLD_KCDT_RIGHT { get; set; }
        public string PART_EYE_GLASS_KCDT_LEFT { get; set; }
        public string PART_EYE_GLASS_KCDT_RIGHT { get; set; }
