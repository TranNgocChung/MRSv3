...
namespace MRS.Processor.Mrs00596
{
    public class Mrs00596RDO
    {
        ...
        public decimal END_AMOUNT { get; set; }//Tồn kho
        public decimal ALL_STOCK_END_AMOUNT { get; set; }//Tổng tồn tất cả các kho
        ...
        public Mrs00596RDO(V_HIS_IMP_MEST_MEDICINE r, List<V_HIS_MEDICINE_TYPE> listHisMedicineType, List<V_HIS_BID_MEDICINE_TYPE> listHisBidMedicineType, List<HIS_MEDICINE_BEAN> listHisMedicineBean, List<V_HIS_MEDICINE> listHisMedicine)
        {
            ...
            if (listHisMedicineBean != null)
            {
                var medicineBeanSubs = listHisMedicineBean.Where(o => o.MEDICINE_ID == r.MEDICINE_ID && o.MEDI_STOCK_ID == r.MEDI_STOCK_ID).ToList();
                ...
                var medicineBeanSubsAllStock = listHisMedicineBean.Where(o => o.MEDICINE_ID == r.MEDICINE_ID).ToList();
                if (medicineBeanSubsAllStock != null) this.ALL_STOCK_END_AMOUNT = medicineBeanSubsAllStock.Sum(s => s.AMOUNT);
            }
        ...
        public Mrs00596RDO(V_HIS_IMP_MEST_MATERIAL r, List<V_HIS_MATERIAL_TYPE> listHisMaterialType, List<V_HIS_BID_MATERIAL_TYPE> listHisBidMaterialType, List<HIS_MATERIAL_BEAN> listHisMaterialBean, List<V_HIS_MATERIAL> listHisMaterial)
        {
            ...
            this.IMP_AMOUNT = r.AMOUNT;
            this.IMP_TOTAL_PRICE = r.AMOUNT * this.IMP_PRICE;
            if (listHisMaterialBean != null)
            {
                var materialBeanSubs = listHisMaterialBean.Where(o => o.MATERIAL_ID == r.MATERIAL_ID && o.MEDI_STOCK_ID == r.MEDI_STOCK_ID).ToList();
                ...
                var materialBeanSubsAllStock = listHisMaterialBean.Where(o => o.MATERIAL_ID == r.MATERIAL_ID).ToList();
                if (materialBeanSubsAllStock != null)
                {
                    this.ALL_STOCK_END_AMOUNT = materialBeanSubsAllStock.Sum(s => s.AMOUNT);
                }
            }
