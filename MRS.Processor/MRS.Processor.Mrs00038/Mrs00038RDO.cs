...
namespace MRS.Processor.Mrs00038
{
    public class Mrs00038RDO
    {
        ...
        public string DEPARTMENT_TRAN_NAMEs { get; set; }
        public string DEPARTMENT_TRAN_CODEs { get; set; }
        public string IN_DEPARTMENT_CODE { get; set; }
        public string IN_DEPARTMENT_NAME { get; set; }
        public string HOSPITALIZE_DEPARTMENT_CODE { get; set; }
        public string HOSPITALIZE_DEPARTMENT_NAME { get; set; }
