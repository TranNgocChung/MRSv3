    ...
    public class ManagerSql
    {
        public List<Mrs00040RDO> GetSereServ(Mrs00040Filter filter)
        {
            try
            {
                ...
                //Neu la truy van theo thoi gian giao dich thi join de chi lay cac ban ghi da co giao dich, con nguoc lai thi "left join", de lay ca cac dich vu chua duoc thanh toan
