...
namespace MRS.Processor.Mrs00290
{
    class Mrs00290Processor : AbstractProcessor
    {
        ...
        List<Mrs00290RDO> ListParent = new List<Mrs00290RDO>();
            ...
            try
            {
                ...
                if (IsNotNullOrEmpty(ListRdo))
                {
                    ...
                    foreach (var rdo in ListRdo)
                    {
                        ...
                        if (rdo.PATIENT_TYPE_ID == HisPatientTypeCFG.PATIENT_TYPE_ID__DV)
                        {
                            rdo.TOTAL_PATIENT_PRICE_DV = (rdo.VIR_TOTAL_PATIENT_PRICE ?? 0) - (rdo.VIR_TOTAL_PATIENT_PRICE_BHYT ?? 0);
                        }
                        ...
                        rdo.REQUEST_DEPARTMENT_NUM_ORDER = (HisDepartmentCFG.DEPARTMENTs.FirstOrDefault(o => o.ID == rdo.TDL_REQUEST_DEPARTMENT_ID) ?? new HIS_DEPARTMENT()).NUM_ORDER ?? 999;
                        ...
                        rdo.EXECUTE_DEPARTMENT_NUM_ORDER = (HisDepartmentCFG.DEPARTMENTs.FirstOrDefault(o => o.ID == rdo.TDL_EXECUTE_DEPARTMENT_ID) ?? new HIS_DEPARTMENT()).NUM_ORDER ?? 999;
                ...
                ListParent = ListRdo.GroupBy(o => o.DATA_PARENT_GROUP_KEYWORD).Select(p => p.First()).ToList();
        ...
        protected override void SetTag(Dictionary<string, object> dicSingleTag, ProcessObjectTag objectTag, Store store)
        {
            ...
            objectTag.AddObjectData(store, "RealParent", ListParent);
            objectTag.AddObjectData(store, "Report", ListRdo);
            objectTag.AddRelationship(store, "Parent", "Report", "REQ_LOGINNAME", "REQ_LOGINNAME");
            objectTag.AddRelationship(store, "RealParent", "Report", "DATA_PARENT_GROUP_KEYWORD", "DATA_PARENT_GROUP_KEYWORD");

            //objectTag.AddObjectData(store, "Department", HisDepartmentCFG.DEPARTMENTs);
