...
namespace MRS.Processor.Mrs00290
{
    ...
    {
        public string DATA_PARENT_GROUP_KEYWORD { get; set; }   //Trường để custom group data theo sheet ReplaceSql trên Template
        //
        ...
        public decimal TOTAL_PATIENT_PRICE_DV { get; set; }
        ...
        private long last_department_num_order = 999;
        public long LAST_DEPARTMENT_NUM_ORDER
        {
            get { return last_department_num_order; }
            set { last_department_num_order = value; }
        }
        public string FIRST_DEPARTMENT_CODE { get; set; }
        public string FIRST_DEPARTMENT_NAME { get; set; }
        private long first_department_num_order = 999;
        public long FIRST_DEPARTMENT_NUM_ORDER
        {
            get { return first_department_num_order; }
            set { first_department_num_order = value; }
        }
        ...
        private long request_department_num_order = 999;
        public long REQUEST_DEPARTMENT_NUM_ORDER
        {
            get { return request_department_num_order; }
            set { request_department_num_order = value; }
        }
        ...
        private long execute_department_num_order = 999;
        public long EXECUTE_DEPARTMENT_NUM_ORDER
        {
            get { return execute_department_num_order; }
            set { execute_department_num_order = value; }
        }
        public string DOCTOR_USERNAME { get; set; } //Neu la y lenh kham thi lay execute_username, neu ko phai y lenh kham thi lay request_username
        public string DOCTOR_LOGINNAME { get; set; } //Neu la y lenh kham thi lay execute_loginname, neu ko phai y lenh kham thi lay request_loginname
        public string DOCTOR_DEPARTMENT_CODE { get; set; } //khoa tuong ung voi doctor_loginname
        public string DOCTOR_DEPARTMENT_NAME { get; set; } //khoa tuong ung voi doctor_loginname
        ...
        public string EXTRA_DATA_1 { get; set; } //Truong mo rong de cho phep lay them truong du lieu moi theo sheet ReplaceSql trên Template ma khong phai sua .dll
        public string EXTRA_DATA_2 { get; set; } //Truong mo rong de cho phep lay them truong du lieu moi theo sheet ReplaceSql trên Template ma khong phai sua .dll
        public string EXTRA_DATA_3 { get; set; } //Truong mo rong de cho phep lay them truong du lieu moi theo sheet ReplaceSql trên Template ma khong phai sua .dll
        public string EXTRA_DATA_4 { get; set; } //Truong mo rong de cho phep lay them truong du lieu moi theo sheet ReplaceSql trên Template ma khong phai sua .dll
        public string EXTRA_DATA_5 { get; set; } //Truong mo rong de cho phep lay them truong du lieu moi theo sheet ReplaceSql trên Template ma khong phai sua .dll
