...
namespace MRS.Processor.Mrs00042
{
    public class Mrs00042RDO
    {
        ...
        public string SUBCLINICAL_RESULT_LOGINNAME { set; get; }
        public string SUBCLINICAL_RESULT_USERNAME { set; get; }//Bác sỹ đọc KQ
        ...
        public string INVOICE_CODE { get; set; } //Id dinh danh hoa don tren he thong hddt
        public string INVOICE_LOOKUP_CODE { get; set; } //Ma tra cuu hoa don.
