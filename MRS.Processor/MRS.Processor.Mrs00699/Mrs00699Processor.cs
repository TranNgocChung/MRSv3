            ...
            try
            {
                    ...
                    if (castFilter.TREATMENT_TYPE_IDs != null)
                {
                    if (castFilter.IS_VIENPHI != null && castFilter.IS_VIENPHI == true)
                    {
                        ...
                        var treatments = ListTreatment.Where(x => patientTypeVPIds.Contains(x.TDL_PATIENT_TYPE_ID ?? 0)).ToList();
                    ...
                    ListTreatment = ListTreatment.Distinct().ToList();
                }
                else
                {
                    if (castFilter.IS_VIENPHI != null && castFilter.IS_VIENPHI == true)
