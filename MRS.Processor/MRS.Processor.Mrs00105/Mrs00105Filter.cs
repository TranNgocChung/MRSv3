...
namespace MRS.Processor.Mrs00105
{
    public class Mrs00105Filter
    {
        ...
        public string MEDI_STOCK_CODE__IMPs { get; set; }//   danh sách các kho nhập của phiếu xuất chuyển kho. Sql: select distinct ms.medi_stock_code from his_exp_mest im join his_medi_stock ms on ms.id=im.imp_medi_stock_id where im.imp_medi_stock_id is not null;
