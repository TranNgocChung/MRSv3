...
namespace MRS.Processor.Mrs00059
{
    ...
    class BillRDO
    {
        ...
        public BillRDO(V_HIS_TREATMENT treatment, V_HIS_TRANSACTION bill, List<HIS_SERE_SERV_BILL> ssbSub, List<V_HIS_TRANSACTION> transactionSub, List<V_HIS_SERE_SERV> listSereServSub, List<HIS_SERE_SERV_DEPOSIT> ssdSub, List<HIS_SESE_DEPO_REPAY> ssrSub, Dictionary<long, string> dicCategory, Mrs00059Filter castFilter)
        {
            ...
            AddInfoBillDetail(ssbSub, listSereServSub, ssdSub, ssrSub, dicCategory);

        }

        private void AddInfoBillDetail(List<HIS_SERE_SERV_BILL> ssbSub, List<V_HIS_SERE_SERV> listSereServSub, List<HIS_SERE_SERV_DEPOSIT> ssdSub, List<HIS_SESE_DEPO_REPAY> ssrSub, Dictionary<long, string> dicCategory)
        {
