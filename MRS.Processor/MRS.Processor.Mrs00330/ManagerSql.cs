    ...
    public partial class ManagerSql : BusinessBase
    {
        ...
        public List<D_HIS_SERE_SERV_BILL> GetSSB(Mrs00330Filter filter)
        {
            ...
            try
            {
                ...
                query += "sr.request_room_id tdl_request_room_id,\n";
                ...
                query += "sr.execute_room_id tdl_execute_room_id,\n";
                query += "sr.execute_department_id tdl_execute_department_id,\n";
                ...
                query += "join his_rs.his_service_req sr on sr.id = ssb.tdl_service_req_id\n";
                query += "join his_rs.his_service sv on sv.id = ssb.tdl_service_id\n";
                ...
                query += string.Format("AND (TRAN.IS_CANCEL IS NULL AND TRAN.TRANSACTION_TIME BETWEEN {0} AND {1} OR TRAN.IS_CANCEL = 1 AND TRAN.CANCEL_TIME BETWEEN {0} AND {1}) \n", filter.TIME_FROM, filter.TIME_TO);
                Inventec.Common.Logging.LogSystem.Info("SQL: " + query);
