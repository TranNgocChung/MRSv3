...
namespace MRS.Processor.Mrs00652
{
    class Mrs00652RDO
    {
        ...
        public string MEDI_ORG_CODE { get; set; }   //DKKCBBD
        ...
        public decimal PTTT_PRICE { get; set; }
        ...
        public int FEE_LOCK_MONTH { get; set; }

        public int FEE_LOCK_YEAR { get; set; }

        public string EXECUTE_DATE { get; set; }

        public string HEIN_CARD_FROM_TIME { get; set; }
        ...
        public Mrs00652RDO(V_HIS_HEIN_APPROVAL heinApproval)
        {
            ...
            this.ADDRESS = heinApproval.ADDRESS;
            this.EXECUTE_DATE = heinApproval.EXECUTE_TIME.HasValue ? Inventec.Common.DateTime.Convert.TimeNumberToDateString(heinApproval.EXECUTE_TIME.Value) : "";
            this.HEIN_CARD_FROM_TIME = Inventec.Common.DateTime.Convert.TimeNumberToDateString(heinApproval.HEIN_CARD_FROM_TIME);
            this.HEIN_CARD_TO_TIME = Inventec.Common.DateTime.Convert.TimeNumberToDateString(heinApproval.HEIN_CARD_TO_TIME);
            this.RIGHT_ROUTE_CODE = heinApproval.RIGHT_ROUTE_CODE;
            this.RIGHT_ROUTE_TYPE_CODE = heinApproval.RIGHT_ROUTE_TYPE_CODE;
            ...
            {
                this.RIGHT_ROUTE_TYPE_NAME = "Cấp cứu";
            }
            else if (heinApproval.RIGHT_ROUTE_TYPE_CODE == MOS.LibraryHein.Bhyt.HeinRightRouteType.HeinRightRouteTypeCode.PRESENT)
            {
                this.RIGHT_ROUTE_TYPE_NAME = "Có giới thiệu";
            }
