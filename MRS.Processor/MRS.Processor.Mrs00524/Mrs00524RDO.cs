...
namespace MRS.Processor.Mrs00524
{
    ...
    {
        public decimal HT_AMOUNT { get; set; }  //Số lượng hoàn trả
        ...
        public Mrs00524RDO(V_HIS_EXP_MEST_MEDICINE r, V_HIS_IMP_MEST_MEDICINE phieuHoanTra, Mrs00524Filter filter, List<HIS_SERVICE_REQ> listHisServiceReq, List<HIS_EMPLOYEE> listEmployee)
        {
            ...
            {
                this.HT_AMOUNT = phieuHoanTra.AMOUNT;
                if (filter.IS_AMOUNT_MINUS_HT == true) this.AMOUNT -= phieuHoanTra.AMOUNT;
            }
