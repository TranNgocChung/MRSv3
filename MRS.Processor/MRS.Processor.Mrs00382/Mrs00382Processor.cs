...
material_id";
        ...
        private void ProcessPatientType(List<V_HIS_EXP_MEST_MEDICINE> listMedi, List<V_HIS_EXP_MEST_MATERIAL> listMate, List<V_HIS_IMP_MEST_MEDICINE> listImpMestMedicine, List<V_HIS_IMP_MEST_MATERIAL> listImpMestMaterial, List<V_HIS_IMP_MEST> listImp)
        {
            try
            {
                ...
                Mrs00382RDO[] arrayCabinet = new Mrs00382RDO[cabinets.Count];
                cabinets.CopyTo(arrayCabinet);
                foreach (var item in arrayCabinet)
                {
                ...
                listForCabinet = arrayCabinet.ToList();
                ...
                Mrs00382RDO[] arrayForPatientType = new Mrs00382RDO[forPatientType.Count];
                forPatientType.CopyTo(arrayForPatientType);
                foreach (var item in arrayForPatientType)
                {
                ...
                listForPatientType = arrayForPatientType.ToList();
