...
namespace MRS.Processor.Mrs00553
{
    class Mrs00553Processor : AbstractProcessor
    {
        ...
        public List<V_HIS_IMP_MEST_MATERIAL> ListImpMestChemicalSubStance = new List<V_HIS_IMP_MEST_MATERIAL>();
        ...
        protected override bool GetData()
        {
            ...
            try
            {
                ...
                {
                    if (castFilter.SERVICE_TYPE_IDs.Count == 1 && castFilter.SERVICE_TYPE_IDs.Contains(medicineServiceTypeId))
                    {
                        takeMedicineData = true;
                        takeMaterialData = false;
                        takeChemicalSubstanceData = false;
                    }
                    else if (castFilter.SERVICE_TYPE_IDs.Count == 1 && castFilter.SERVICE_TYPE_IDs.Contains(materialServiceTypeId))
                    {
        ...
        protected override bool ProcessData()
        {
            ...
            try
            {
                if (IsNotNullOrEmpty(ListImpMest))
                {
                    ...
                    if (IsNotNullOrEmpty(ListImpMestMedicine) || IsNotNullOrEmpty(ListImpMestMaterial) || IsNotNullOrEmpty(ListImpMestChemicalSubStance))
                    {
        ...
        protected override void SetTag(Dictionary<string, object> dicSingleTag, Inventec.Common.FlexCellExport.ProcessObjectTag objectTag, Inventec.Common.FlexCellExport.Store store)
        {
            try
            {
                ...
                //dữ liệu gốc
                ListImpMest = ListImpMest.Where(o => ListImpMestMedicine.Exists(p => p.IMP_MEST_ID == o.ID) || ListImpMestMaterial.Exists(p => p.IMP_MEST_ID == o.ID) || ListImpMestChemicalSubStance.Exists(p => p.IMP_MEST_ID == o.ID)).ToList();
