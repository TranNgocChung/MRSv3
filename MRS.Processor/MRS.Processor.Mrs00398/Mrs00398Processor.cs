    ...
    class Mrs00398Processor : AbstractProcessor
    {
        ...
        private void CalcuatorAge(Mrs00398RDO rdo, HIS_TREATMENT treatment)
        {
            try
            {
                ...
                {
                    rdo.MALE_AGE_FULL_STR = Inventec.Common.DateTime.Calculation.AgeCaption(treatment.TDL_PATIENT_DOB);
                }
                else // Tuoi nu
                {
                    rdo.FEMALE_AGE_FULL_STR = Inventec.Common.DateTime.Calculation.AgeCaption(treatment.TDL_PATIENT_DOB);
                }
                //
