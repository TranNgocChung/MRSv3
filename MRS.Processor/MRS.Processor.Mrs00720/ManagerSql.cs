...
namespace MRS.Processor.Mrs00720
{
    internal class ManagerSql
    {
        ...
        internal List<VTreatmentFee> GetTreatmentFee(Mrs00720Filter filter, bool isCancel)
        {
            List<VTreatmentFee> result = new List<VTreatmentFee>();
            try
            {
                string query = "";
                ...
                query += "trea.TDL_HEIN_MEDI_ORG_NAME,";
                ...
                result = new MOS.DAO.Sql.SqlDAO().GetSql<VTreatmentFee>(query);
            }
            catch (Exception ex)
            {
                LogSystem.Error(ex);
        ...
        internal List<VTreatmentFee> GetTreatmentFeeNoBill(Mrs00720Filter filter)
        {
            List<VTreatmentFee> result = new List<VTreatmentFee>();
            try
            {
