...
namespace MRS.Processor.Mrs00584
{
    class Mrs00584RDO : IMP_EXP_MEST_TYPE
    {
        ...
        public string MEDICINE_TYPE_USE_FORM_CODE { get; set; }//mã đường dùng
        public string MEDICINE_TYPE_USE_FORM_NAME { get; set; }//tên đường dùng
        ...
        public Mrs00584RDO(V_HIS_IMP_MEST_MEDICINE r, Dictionary<long, V_HIS_MEDICINE_TYPE> dicMedicineType, List<HIS_MEDICINE> Medicines)
        {
            ...
            {
                AddMedicineType(dicMedicineType[r.MEDICINE_TYPE_ID]);
            }
        ...
        private void AddMedicineType(V_HIS_MEDICINE_TYPE medicineType)
        {
            this.SERVICE_CODE = medicineType.MEDICINE_TYPE_CODE;
            this.SERVICE_NAME = medicineType.MEDICINE_TYPE_NAME;
            //
            ...
            this.MEDICINE_TYPE_USE_FORM_CODE = medicineType.MEDICINE_USE_FORM_CODE;
            this.MEDICINE_TYPE_USE_FORM_NAME = medicineType.MEDICINE_USE_FORM_NAME;
            ...
            this.SCIENTIFIC_NAME = medicineType.SCIENTIFIC_NAME;
            this.PREPROCESSING = medicineType.PREPROCESSING;
            this.PROCESSING = medicineType.PROCESSING;
            this.USED_PART = medicineType.USED_PART;
            this.DOSAGE_FORM = medicineType.DOSAGE_FORM;
            this.DISTRIBUTED_SL = medicineType.DISTRIBUTED_AMOUNT;
        ...
        public Mrs00584RDO(Mrs00584RDO r, Dictionary<long, V_HIS_MEDICINE_TYPE> dicMedicineType, List<HIS_MEDICINE> Medicines)
        {
            ...
            if (Medicine != null)
            {
                ...
                {
                    AddMedicineType(dicMedicineType[Medicine.MEDICINE_TYPE_ID]);
                }
